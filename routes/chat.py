...
def _apply_mentions(message, project):
    ...
    for uid in mentioned:
        notify(uid, "task", f'{message.author.full_name} mentioned you in chat',
...
def send():
    ...
    if parent_id:
        ...
        if parent and parent.author_id != current_user.id:
            notify(parent.author_id, "task", f'{current_user.full_name} replied to your message',
                   url=_message_url(msg))

    _apply_mentions(msg, project)
