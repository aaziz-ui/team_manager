...
from status_tracking import (
    compute_daily_hours, seconds_to_hm, get_day_activity_window, work_window_utc, late_minutes,
)
...
def hours_export_csv():
    ...
    writer.writerow(["Employee", "Started (PT)", "Late by (min)", "Ended (PT)", "On-desk total",
